...
Version  : 5.56.0
Release  : 11
URL      : https://download.kde.org/stable/frameworks/5.56/syndication-5.56.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.56/syndication-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/syndication-5.56.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1552154856
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Syndication.so.5.56.0
