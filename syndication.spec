...
Source0  : https://download.kde.org/stable/frameworks/5.88/syndication-5.88.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.88/syndication-5.88.0.tar.xz.sig
...
%prep
%setup -q -n syndication-5.88.0
cd %{_builddir}/syndication-5.88.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637003788
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/syndication-5.88.0/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/syndication/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/syndication-5.88.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/syndication/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/syndication-5.88.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/syndication/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/syndication-5.88.0/autotests/LICENSE.UNITTESTS %{buildroot}/usr/share/package-licenses/syndication/02e5e301efb9adac8a5f1ba32855c8d02d5abd7d
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Syndication.so.5.88.0
