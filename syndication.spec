...
Version  : 5.111.0
Release  : 66
URL      : https://download.kde.org/stable/frameworks/5.111/syndication-5.111.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.111/syndication-5.111.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.111/syndication-5.111.0.tar.xz.sig
...
%prep
%setup -q -n syndication-5.111.0
cd %{_builddir}/syndication-5.111.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698096894
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Syndication.so.5.111.0
/usr/lib64/libKF5Syndication.so.5
/usr/lib64/libKF5Syndication.so.5.111.0
