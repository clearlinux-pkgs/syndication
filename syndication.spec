...
Version  : 5.58.0
Release  : 15
URL      : https://download.kde.org/stable/frameworks/5.58/syndication-5.58.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.58/syndication-5.58.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.58/syndication-5.58.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557778949
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5Syndication.so.5.58.0
